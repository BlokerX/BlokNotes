    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                GlobalSettings.MainSavePath = Path.Combine(Windows.Storage.ApplicationData.Current.LocalFolder.Path, "BlokNotes");
...
#if DEBUG
                    Debug.WriteLine($"Use path: {absolutePath}");
#endif
                };
